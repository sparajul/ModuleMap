...
add wave -group {Summary} -color white /graph_constructor_tb/UUT/module_mapper_0/GEN_HIT_BUFFER(0)/hit_buffer_gen/FLAG_RESET
add wave -group {Summary} -color white /graph_constructor_tb/UUT/module_mapper_0/GEN_HIT_BUFFER(1)/hit_buffer_gen/FLAG_RESET
add wave -group {Summary} -color white /graph_constructor_tb/UUT/module_mapper_0/GEN_HIT_BUFFER(2)/hit_buffer_gen/FLAG_RESET
add wave -group {Summary} -radix hex /graph_constructor_tb/UUT/module_mapper_0/output_manager_0/EDGE_CALC_WREN
